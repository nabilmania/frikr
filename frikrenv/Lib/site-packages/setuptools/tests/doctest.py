...
def _module_relative_path(module, path):
    ...
    if hasattr(module, '__file__'):
        ...
        # A module w/o __file__ (this include builtins)
...
##   "source."  The Example class also include information about
##   where the example was extracted from.
##
## - A "doctest" is a collection of examples, typically extracted from
##   a string (such as an object's docstring).  The DocTest class also
##   include information about where the string was extracted from.
...
class DocTestCase(unittest.TestCase):
    ...
    def debug(self):
        r"""Run the test case without results and without catching exceptions
           ...
           The unit test framework include a debug method on test cases
